...
-- CreateEnum
CREATE TYPE "public"."status" AS ENUM ('NEW', 'ASSIGNED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "_categoriesTotickets_B_index" ON "public"."_categoriesTotickets"("B");
...
-- AddForeignKey
ALTER TABLE "public"."tickets" ADD CONSTRAINT "tickets_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."_categoriesTotickets" ADD CONSTRAINT "_categoriesTotickets_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."categories"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_categoriesTotickets" ADD CONSTRAINT "_categoriesTotickets_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."tickets"("id") ON DELETE CASCADE ON UPDATE CASCADE;
